...
public class NewCVTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        frontOfStoneCoOrdinates[1] = Vector2Weighted.createVector(STONE_WALL_DISTANCE - BACKUP_DISTANCE, 0);
    ...
    static class LivePipeline extends OpenCvPipeline {
        /*
         * NOTE: if you wish to use additional Mat objects in your processing pipeline, it is
         * highly recommended to declare them here as instance variables and re-use them for
         * each invocation of processFrame(), rather than declaring them as new local variables
        ...
        public Mat processFrame(Mat input) {
            ...
            double[] hsvThresholdHue = {0.0, 95.9592529711375};
        ...
        private void cvErode(Mat src, Mat kernel, Point anchor, double iterations,
         ...
         enum BlurType{
            ...
            public BlurType get(String type) {
