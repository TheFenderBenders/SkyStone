 ...
 */
@Autonomous(name= "Blue Foundation Neutral",group = "drive")
public class BlueFoundationNeutral extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()){
            ...
            rightFoundation.setPosition(0);
            sleep(750);
            drive.followTrajectorySync(drive.trajectoryBuilder().strafeLeft(27).build());
